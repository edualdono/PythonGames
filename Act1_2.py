...
class Game:
    ...
    def __init__(self):
        ...
        self.mensaje = ' HOLA JESUS!!! COMO VAS? '
        self.time = 0
...
class Letras:
    ...
    def __init__(self, window_size, text, num_fuente):
        ...
        self.index_act = 0
        self.velocidad = 1/10
        self.position = pygame.math.Vector2(-window_size[0]*10,window_size[1]/2)
    ...
    def render(self, destino):
        letras_esc = int((self.window_size[0]*3 - self.position.x) / self.__letras.tamanio[0]) +1
        #print(letras_esc)
