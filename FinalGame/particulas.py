...
class AnimationPlayer:
    def __init__(self):
        self.frames = {
            ...
            'nova': import_folder('./graphics/particles/nova'),
            ...
            'boss': import_folder('./graphics/particles/boss'),
    ...
    def reflect_images(self,frames):
        ...
        for frame in frames:
            frame_volteado = pygame.transform.flip(frame,True,False)
            new_frames.append(frame_volteado)
        return new_frames

    def create_particles(self,animation_type,pos,groups):
        print(animation_type)
        animation_frames = self.frames[animation_type]
        Particulas(pos,animation_frames,groups)
